...
class RefactoredExample(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        static = wx.StaticText(panel, wx.NewIdRef(), "First Name", pos=(10,50))
        static.SetBackgroundColour("White")
        text = wx.TextCtrl(panel, wx.NewIdRef(), "", size=(100,-1), pos=(80,50))

        static2 = wx.StaticText(panel, wx.NewIdRef(), "Last Name", pos=(10,80))
        static2.SetBackgroundColour("White")
        text2 = wx.TextCtrl(panel, wx.NewIdRef(), "", size=(100,-1), pos=(80,80))
...
if __name__ == '__main__':
    app = wx.App()
    frame = RefactoredExample(None, -1)
    frame.Show()
    app.MainLoop()
